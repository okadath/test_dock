...
window.jwplayer = (function (t) {
    ...
    function (t, e, n) {
        ...
        var r = n(31),
            ...
            u = function () {
                var t = "//ssl.p.jwpcdn.com/player/v/8.14.0/";
            ...
            var h = Object(r.j)(
                ...
                v = (function (t, e) {
                    return function (t, n) {
                        ...
                        if ((clearTimeout(e.timeoutId), e.retryWithoutCredentials && e.xhr.withCredentials)) return s(i), void c(Object(r.j)({}, e, { xhr: null, withCredentials: !1, retryWithoutCredentials: !1 }));
    ...
    function (t, e, n) {
        ...
        function d(t, e, n) {
            var i = t.getProviders(),
                u = t.get("preload"),
                a = Object(r.j)({}, e);
            if (((a.preload = o(e.preload, u)), (a.allSources = h(e, t)), (a.sources = v(a.allSources, i)), a.sources.length))
                return (
                ...
                .map(function (e) {
                    ...
                    m(e, n, "androidhls"),
                        ...
                        (function (t, e, n) {
                            ...
                            m(t, r, "liveSyncDuration");
                        })(e, t, n),
                        m(e, n, "_hlsjsProgressive"),
    ...
    function (t, e, n) {
        ...
        var r =
            "8.14.0+commercial_v8-14-0.398.commercial.e9a133e.hlsjs.eeefcce.hlsjsprogressive.06278c3.jwplayer.89a1f0a.dai.07e1a38.freewheel.af0c077.googima.3bea836.googimanvmp.6873d1e.headerbidding.c2b079a.vast.fc45163.analytics.f8ec4b5.gapro.141397a";
    },
    function (t, e, n) {
        "use strict";
        var r = n(0),
    ...
    function (t, e, n) {
        ...
        e.b = function (t, e) {
            ...
            var y = v.playlist;
            if (y) Array.isArray(y.playlist) && ((v.feedData = y), (v.playlist = y.playlist));
            else {
            ...
            var O,
                k,
                C = parseFloat(v.bandwidthEstimate),
                x = parseFloat(v.bitrateSelection);
            return (
                (v.bandwidthEstimate = Object(r.z)(C) ? C : ((O = v.defaultBandwidthEstimate), (k = parseFloat(O)), Object(r.z)(k) ? Math.max(k, 1) : l.bandwidthEstimate)),
    ...
    function (t, e, n) {
        ...
        function g(t, e) {
            var n = "file:" === window.location.protocol ? "https:" : "",
                r = {
                    bidding: "//ssl.p.jwpcdn.com/player/plugins/bidding/v/0.3.9/bidding.js",
                    jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.14.0/jwpsrv.js",
                    dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.13/dai.js",
                    vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.7.16/vast.js",
                    googima: e ? "//ssl.p.jwpcdn.com/player/v/8.14.0/googimanvmp.js" : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.7.17/googima.js",
...
var jwDefaults = {
    ...
    displaytitle: false,
    flashplayer: "//ssl.p.jwpcdn.com/player/v/8.14.0/jwplayer.flash.swf",
    height: 270,
    key: "odCXfVo6EuyE/P70GCrpXslXEZKUOZSJh7jLk13uNKlBWLNr3KklAI77CIs=",
    mute: false,
    ph: 1,
    pid: "9hfAAeXQ",
